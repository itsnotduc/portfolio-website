                    ...
                    <motion.section className='group bg-gray-100 max-w-[45rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[22rem] rounded-xl even:pl-8 hover:bg-gray-200 transition duration-200'>
                        <div className='pt-4 pb-8 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[20rem]'>
                            ...
                            <ul className='flex flex-wrap mt-4 gap-2 sm:mt-auto'>
                                {tags?.map((tag, index) => (
                                    <li 
                                        className="bg-black/[0.7] px-3 py-2 text-[0.7rem] uppercase tracking-wider text-white rounded-full shadow-md shadow-gray-500" 
                                        key={index}
                                    >
                                        {tag}
                                    </li>
                        ...
                        {imageUrl && (
                            <Image
                                ...
                                width={500}
                                height={300}
                                className='absolute top-[130px] -right-40 w-[28.25rem] rounded-t-lg shadow-2xl shadow-black group-even:right-[initial] group-even:-left-40 group-hover:-translate-x-5 group-hover:translate-y-3 group-hover:-rotate-2 transition duration-300 group-hover:scale-110 group-even:group-hover:translate-x-5 group-even:group-hover:translate-y-3 group-even:group-hover:rotate-2'
                            />
                        )}
                    </motion.section>
                </motion.div>
